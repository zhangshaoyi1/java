...
import cn.edu.ccnu.imd.gsmis.entity.Phone;
import cn.edu.ccnu.imd.gsmis.service.PhoneService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/gsmis/phone")
public class PhoneController extends BaseController {
	...
	@RequiresPermissions("gsmis:phone:view")
	...
	public String form(Phone phone, Model model) {
		...
		return "imd/gsmis/phoneForm";
	}

	@RequiresPermissions("gsmis:phone:edit")
	...
	public String save(Phone phone, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/gsmis/phone/?repage";
	}
