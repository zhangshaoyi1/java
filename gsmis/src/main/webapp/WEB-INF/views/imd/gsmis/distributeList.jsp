	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#fenpeiAll").click(function(){
				...
				$("#distributeForm").attr("action","${ctx}/gsmis/distribute/fenpeiAll?thesisIds=" + thesisIds);
				$("#distributeForm").submit();
			});
			
			$("#allFenpei").click(function(){
				$("#distributeForm").attr("action","${ctx}/gsmis/distribute/allFenpei");
				$("#distributeForm").submit();
			});
		...
		<c:forEach items="${page.list}" var="distribute">
			<tr>
				...
				<shiro:hasPermission name="gsmis:distribute:edit">
					<td>
    					<a href="${ctx}/gsmis/distribute/fenpei?id=${distribute.thesisid}">分配</a>
					</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
