...
<head>
	...
	<script type="text/javascript">
		...
		function addNewResearch() {
			top.$.jBox.open("iframe:${ctx}/jwcmis/research/form", "新增研究方向",$(top.document).width()-700,$(top.document).height()-165,{							
				buttons:{"确定":true}, 
				loaded:function(h){
...
<body>
	...
	<form:form id="searchForm" modelAttribute="research" action="${ctx}/jwcmis/research/selectList" method="post" class="breadcrumb form-search">
