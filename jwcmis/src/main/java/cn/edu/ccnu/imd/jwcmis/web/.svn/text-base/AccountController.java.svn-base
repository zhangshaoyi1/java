 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/jwcmis/account")
public class AccountController extends BaseController {
	...
	@RequiresPermissions("jwcmis:account:view")
	...
	public String form(Account account, Model model) {
		...
		return "imd/jwcmis/accountForm";
	}

	@RequiresPermissions("jwcmis:account:edit")
	...
	public String save(Account account, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/jwcmis/account/?repage";
	}
